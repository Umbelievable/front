                    ...
                    <form className="form-horizontal" style={{paddingRight:'12em'}}>
                        <div className="form-group">
                            <label style={{fontSize:'14px'}} for="title" className="col-sm-2 control-label">제목</label>
                                <div className="col-sm-10">
                                    <input style={{fontSize:'14px', height:'30px'}} type="text" className="form-control" placeholder="제목을 입력해 주세요." value={this.state.qboardTitle} onChange={this.changeTitleHandler}/>
                                </div>
                        </div>
                        ...
                        <div className="form-group">
                            <label style={{fontSize:'14px'}} for="content" className="col-sm-2 control-label">내용</label>
                                <div className="col-sm-10">
                                    <textarea style={{height:'200px', fontSize:'14px'}} className="form-control" placeholder="내용을 입력해 주세요." value={this.state.qboardContent} onChange={this.changeContentHandler}></textarea>
                                </div>
                        </div>
