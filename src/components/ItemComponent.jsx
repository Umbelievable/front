...
class ItemComponent extends Component{
    ...
    render(){
        ...
        return (
            ...
            <div class="clearfix"><h4 class="box-title pull-left"></h4>
            ...
            <div>
                ...
                <div key={item.pdNo, item.cateNo, item.thisCateNo}>
                    ...
                    <img src={item.pdImg} style={{display:'inline-block',width:'30%',height:'400px',alignItems:'flex-start',justifyContent:'space-around'}}></img>
                   ...
                   <div style={{ fontWeight:'bolder', fontSize:'20px',color:'#ea4335'}}>{item.pdPrice}</div>
                    <button class="btn btn-primary waves-effect waves-light" style={{marginTop:'130px'}}>BUY NOW</button>
                    <button class="btn btn-primary waves-effect waves-light"style={{marginLeft:"10px",marginTop:'130px'}}>CART</button>
                    </div>  
