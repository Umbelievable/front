                        ...
                        <div className="dropdown" key = {category.cateNo} style={{display:'inline', float:'left'}}> 
                            ...
                            <div className="dropdown-content" style={{left:'0'}}>
                                {category.cateNo == "거실가구" && this.state.livingroom_categories.map(
                                    livingroom_category =>
                                    <a href={`/menu-board?cateNo=거실가구&subcateNo=`+livingroom_category.subcateNo} style={{display:'block', width:'148px'}} key = {livingroom_category.cateNo, livingroom_category.subcateNo}>
                                ...
                                {category.cateNo == "서재/사무용가구" && this.state.library_categories.map(
                                    library_category => 
                                    <a href={`/menu-board?cateNo=서재/사무용가구&subcateNo=`+library_category.subcateNo} style={{display:'block', width:'148px'}} key = {library_category.cateNo, library_category.subcateNo}>
                                ...
                                {category.cateNo == "수납가구" && this.state.storage_categories.map(
                                    storage_category => 
                                    <a href={`/menu-board?cateNo=수납가구&subcateNo=`+storage_category.subcateNo} style={{display:'block', width:'148px'}} key = {storage_category.cateNo, storage_category.subcateNo}>
                                ...
                                {category.cateNo == "주방가구" && this.state.kitchen_categories.map(
                                    kitchen_category => 
                                    <a href={`/menu-board?cateNo=주방가구&subcateNo=`+kitchen_category.subcateNo} style={{display:'block', width:'148px'}} key = {kitchen_category.cateNo, kitchen_category.subcateNo}>
                                ...
                                {category.cateNo == "침실가구" && this.state.bed_categories.map(
                                    bed_category => 
                                    <a href={`/menu-board?cateNo=침실가구&subcateNo=`+bed_category.subcateNo} style={{display:'block', width:'148px'}} key = {bed_category.cateNo, bed_category.subcateNo}>
