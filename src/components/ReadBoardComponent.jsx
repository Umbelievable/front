               ...
               <div className="card-content">
                  ...
                  <form className="form-horizontal form-view">
                     <div className="input-group margin-bottom-20" style={{width:'1400px'}}>
                        <input type="text" className="form-control" value={this.state.qcommentContent} onChange={this.changeContentHandler} style={{height:'45px', fontSize:'13px'}} placeholder="댓글을 입력해 주세요."/>
