            ...
            <Form onSubmit={this.handleRegister} ref={c => {this.form = c;}}>
                ...
                <div>
                    ...
                    <div className="form-group">
                        ...
                        <div style={{display:'inline'}}>
                            <select style={{height:'40px', fontSize:'16px', display: 'inline-block', width: '180px',margin:'0px 0px 0px 0px'}} aial-label="월" name="birM" class="form-control" placeholder="년(4자)"
